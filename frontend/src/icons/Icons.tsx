import type { HexColor } from "../types/types.ts"

export const InfoIcon = ({ color, size } : { color: HexColor, size: number }) => {
    return (
        <svg
            width={size || 18}
            height={size || 18}
...
export const MoreIcon = ({ color } : { color: HexColor }) => {
    return (
        <svg
            width="32"
            height="32"
...
export const SwordIcon = ({ color } : { color: HexColor }) => {
    return (
        <svg
            width="32"
            height="32"
...
export const MenuIcon = ({ color } : { color: HexColor }) => {
    return (
        <svg
            width="32"
            height="32"
...
export const HomeIcon = ({ color } : { color: HexColor }) => {
    return (
        <svg 
            width="16" 
            height="16" 
...
export const MusicNoteIcon = ({ color } : { color: HexColor }) => {
    return (
        <svg 
            height="18px" 
            width="18px" 
...
export const VoiceIcon = ({ color, size }: { color: HexColor, size: number }) => {
    return (
        <svg 
        height={size || 18} 
        width={size || 18} 
...
export const StopIcon = ({ color }: { color: HexColor }) => {
    return (
        <svg 
            height="18px" 
            width="18px" 
...
export const RightArrowIcon = ({ color, size } : { color: HexColor, size: number }) => {
    return (
    <svg
        width={size || 18}
        height={size || 18}
...
export const LeftArrowIcon = ({ color, size } : { color: HexColor, size: number }) => {
    return (
    <svg
        width={size || 18}
        height={size || 18}
